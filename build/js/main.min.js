...
var descriptionExtra = document.querySelector('.about__description--extra');
...
window.addEventListener('DOMContentLoaded', function () {
  var tel = document.querySelectorAll('[name="user-phone"]');
  tel.forEach(function (elem) {
    Object(imask__WEBPACK_IMPORTED_MODULE_2__["default"])(elem, {
